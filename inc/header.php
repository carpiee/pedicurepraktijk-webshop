...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://www.pedicurepraktijkpapendrecht.nl/webshop/css/product.css">
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="sm:ml-4 ml-1 flex w-full sm:w-auto justify-between sm:justify-end">
                    <a href="https://www.pedicurepraktijkpapendrecht.nl/webshop/?cart"
                        ...
                        <svg class="fill-current hover:text-black mr-1" xmlns="http://www.w3.org/2000/svg" width="24"
    ...
    <div class="bg-transparent font-semibold max-w-7xl">
        <div class="container w-full mx-auto max-w-7xl px-6 py-3">
            <span class="flex items-center">
                <img src="https://www.pedicurepraktijkpapendrecht.nl/webshop/img/back.svg" class="h-3 w-3 -mb-px mr-px"
                    alt="">
